...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="zip_code" name="zip_code" pattern="\d{5}" required>
    <div class="invalid-feedback">
        Please provide a valid 5-digit zip code.
            ...
            <!-- User Type -->
            <div class="mb-3">
                <label for="user_type" class="form-label"><i class="fas fa-user-tag"></i> User Type</label>
